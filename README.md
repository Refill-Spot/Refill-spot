...
- **플랫폼별 평점 비교**: 네이버지도와 카카오맵의 평점 및 리뷰를 모달로 간편 확인
...
- [x] **리뷰 시스템**: 사용자 리뷰 작성 및 관리 기능
- [x] **프로필 사진 기능**: 사용자 프로필 이미지 업로드 및 관리
- [x] **네이버/카카오 평점 비교**: 플랫폼별 평점 및 리뷰 모달 연동 완료
- [x] **PWA 기능**: 모바일 앱과 같은 사용자 경험
